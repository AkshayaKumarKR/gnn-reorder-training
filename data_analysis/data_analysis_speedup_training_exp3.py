...
dimensions = {'2': 'Set 1 - Layers = 2', '3': 'Set 2 - Layers = 3', '4': 'Set 3 - Layers = 4'}
strategies = sorted(speedup_results[dimensions['2']].keys())
...
rects1 = ax.bar(x - width, [speedup_results[dimensions['2']][key] for key in strategies], width, label='Layers = 2')
rects2 = ax.bar(x, [speedup_results[dimensions['3']][key] for key in strategies], width, label='Layers = 3')
rects3 = ax.bar(x + width, [speedup_results[dimensions['4']][key] for key in strategies], width, label='Layers = 4')
...
# Save the figure
fig.savefig('speedup_exp3_layers_dgl.png', dpi=300, bbox_inches='tight')
