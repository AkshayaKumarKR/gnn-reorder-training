...
dimensions = {'16': 'Set 1 - Feature Size = 16', '64': 'Set 2 - Feature Size = 64', '512': 'Set 3 - Feature Size = 512'}
...
rects1 = ax.bar(x - width, [speedup_results[dimensions['16']][key] for key in strategies], width, label='Feature Size = 16')
rects2 = ax.bar(x, [speedup_results[dimensions['64']][key] for key in strategies], width, label='Feature Size = 64')
rects3 = ax.bar(x + width, [speedup_results[dimensions['512']][key] for key in strategies], width, label='Feature Size = 512')
...
# Save the figure
fig.savefig('speedup_exp2_feature_size_pyg.png', dpi=300, bbox_inches='tight')
