...
sets = {
    '16': 'Set 1 - Feature Size = 16/pyg',
    '64': 'Set 2 - Feature Size = 64/pyg',
    '512': 'Set 3 - Feature Size = 512/pyg'
}
...
for i, dim in enumerate(dimensions):
    ax.bar(x + i * width, data[dim], width, label=f'Feature Size = {dim}')
...
# Save the figure
plt.savefig('cache_misses_exp2_pyg.png', dpi=300, bbox_inches='tight')
