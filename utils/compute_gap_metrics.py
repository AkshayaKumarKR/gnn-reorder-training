...
if __name__ == '__main__':
    ...
    with open(f'{args.graph_path}.metrics', 'w') as f:
        ...
        f.write(
            f'{args.reordering_strategy},{args.graph_name},{avg_gap:.3f},{avg_bandwidth:.3f},{max_bandwidth:.3f},{avg_aid:.3f},{aid_in:.3f},{aid_out:.3f}')

    print(
        f'{args.reordering_strategy},{avg_gap:.3f},{avg_bandwidth:.3f},{max_bandwidth:.3f},{avg_aid:.3f},{aid_in:.3f},{aid_out:.3f}')
